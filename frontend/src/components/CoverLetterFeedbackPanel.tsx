...
export const CoverLetterFeedbackPanel: React.FC<CoverLetterFeedbackPanelProps> = ({ feedback }) => {
  return (
    <div
      className="cover-letter-feedback-container"
    ...
    >
          ...
          >
            ...
            <span
              style={{
                fontWeight: '700',
                fontSize: '0.9rem',
                color: feedback.relevance.references_role ? '#4ade80' : '#f87171',
              }}
            >
          ...
          >
            ...
            <span
              style={{
                fontWeight: '700',
                fontSize: '0.9rem',
                color: feedback.relevance.references_company ? '#4ade80' : '#f87171',
              }}
            >
      ...
      {((feedback.tone.suggestions && feedback.tone.suggestions.length > 0) ||
        ...
        >
          ...
          >
            {[...(feedback.tone.suggestions || []), ...(feedback.relevance.suggestions || [])].map(
              (suggestion, index) => (
                <li
                  key={index}
                  style={{ fontSize: '0.9rem', color: 'rgba(255,255,255,0.85)', lineHeight: '1.4' }}
                >
                  {suggestion}
                </li>
              )
