...
export const JdVisualizerPanel: React.FC<JdVisualizerPanelProps> = ({ keywords, onBack }) => {
    ...
    return (
      <div className="card glass-card p-5 text-center mt-4">
        <p style={{ color: 'rgba(255,255,255,0.6)' }}>
          No keywords found. Try analyzing a longer, more detailed job description.
        </p>
        <button className="app-btn app-btn--secondary mt-3" onClick={onBack}>
          Go Back
        </button>
      </div>
    )
  ...
  return (
    <div
      className="jd-visualizer-container animate-fade-in"
    ...
    >
      ...
      {/* Row: Word Cloud Card */}
      <div
        className="card glass-card p-4 mb-4"
      ...
      >
        ...
        >
          {keywords.map((item, index) => {
            ...
            const color = isSkill
              ? `rgba(129, 140, 248, ${0.6 + ratio * 0.4})`
              : `rgba(241, 245, 249, ${0.4 + ratio * 0.6})`
