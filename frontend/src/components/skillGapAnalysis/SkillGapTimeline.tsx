...
const ACTION_STYLES: Record<string, { color: string; icon: string }> = {
  REPORT_GENERATED: { color: '#6366f1', icon: '📊' },
  CAREER_PATH_FAVORITED: { color: '#22c55e', icon: '⭐' },
  RESOURCE_BOOKMARKED: { color: '#f59e0b', icon: '🔖' },
  SKILL_SELF_ASSESSED: { color: '#06b6d4', icon: '✏️' },
  REPORT_EXPORTED: { color: '#ec4899', icon: '📤' },
};

export const SkillGapAuditTimeline: React.FC<SkillGapAuditTimelineProps> = ({ logs }) => {
  return (
