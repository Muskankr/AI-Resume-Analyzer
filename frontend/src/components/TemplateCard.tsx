...
export const TemplateCard: React.FC<TemplateCardProps> = ({ name, description, atsNote, fileName, imageSrc }) => {
  return (
    <div className="bg-gray-800 rounded-lg p-4 flex flex-col items-center text-center shadow-lg">
      <img src={imageSrc} alt={`${name} preview`} className="w-full h-48 object-cover rounded mb-4" />
